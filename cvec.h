...
static const double CS150_PI = 3.14159265358979323846264338327950288;
static const double CS150_EPS = 1e-8;
static const double CS150_EPS2 = CS150_EPS * CS150_EPS;
static const double CS150_EPS3 = CS150_EPS * CS150_EPS * CS150_EPS;
...
public:
  ...
  Cvec& normalize() {
    assert(dot(*this, *this) > CS150_EPS2);
